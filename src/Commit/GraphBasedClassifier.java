...
//    static String ,result_dir;
    ...
    public HashMap<String, Integer> getShortestPath_Dij(HashSet<String> latestCommits, Graph graph, HashSet<String> allCommits) {
...
//                        }
    ...
    public void generatingGraphForDijkstra(HashMap<String, ArrayList<String>> historyMap) {
    ...
    public ArrayList<String> exploreParents(String source, String target, String parent) {
        ArrayList<String> path = new ArrayList<>();
    ...
    public HashMap<String, ArrayList<String>> getCommitInBranch(String repo_uri, String forkpointDate, String forkUrl) {
        ...
        for (String branch : branchArray) {
            ...
            try {
                ...
                /**   get No_Merge first parent Commit.Commit  **/
    ...
    public HashMap<String, List<String>> getHistory(String[] branchArray) {
