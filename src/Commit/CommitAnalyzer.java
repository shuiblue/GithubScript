...
//            tch.getRamdomForks(repo_url);
    ...
    private static String analyzingCommits(String upstream_url, String fork_url, String repo_url) {
        Commit.NameBasedClassifier trackCommitHistory = new Commit.NameBasedClassifier();
    ...
    private static HashSet<String> getCommitList(String repo_url, String fork_url) {
        ...
        Commit.NameBasedClassifier tch = new Commit.NameBasedClassifier();
        ...
        IO_Process io = new IO_Process();
        io.rewriteFile(io.removeBrackets(commitList.toString()), result_dir + repo_url + "/" + fork_url.split("/")[0] + "_commitList.txt");
        return commitList;
